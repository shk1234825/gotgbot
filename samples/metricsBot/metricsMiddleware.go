...
func (b metricsBotClient) RequestWithContext(ctx context.Context, token string, method string, params map[string]string, data map[string]gotgbot.InputFile, opts *gotgbot.RequestOpts) (json.RawMessage, error) {
